...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String url = "http://10.0.2.2:15574/BP4Data/webresources/bp4data.bpinteresses";
    ...
    public void buildItems(String response) {
        try {
            ...
            NodeList interesses = doc.getElementsByTagName("bpInteressess");
            NodeList alInteresses = (interesses.item(0)).getChildNodes();
